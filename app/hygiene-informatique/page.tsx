...
import { ArrowRight, BrainCircuit, CheckCircle2, Network, ShieldCheck, Sparkles } from "lucide-react";
...
const clusters = [
  {
    title: "Loi 25",
    description: "Mieux connaître les données, clarifier les formulaires et préparer les demandes de confidentialité.",
    href: "/loi-25",
  ...
  {
    title: "Cybersécurité",
    description: "Renforcer les accès, sauvegardes, courriels, mises à jour et réflexes d'incident.",
    href: "/cybersecurite",
  ...
  },
  {
    ...
    description: "Adopter l'IA avec des règles simples pour les données, les outils et la validation humaine.",
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Sécurité informatique PME | Loi 25, cybersécurité et IA | ForméducWeb",
    description: pageDescription,
    url: hubUrl
  }
};
...
export default function HygieneInformatiquePage() {
  ...
  return (
    <>
      <JsonLd id="hygiene-informatique-collection-schema" value={collectionSchema} />
      <JsonLd id="hygiene-informatique-breadcrumb-schema" value={breadcrumbSchema} />
        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="space-y-7">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-xl leading-9 text-muted-foreground">
                L'hygiène informatique relie la Loi 25, la cybersécurité et l'IA dans une démarche positive: mieux
                connaître vos données, protéger les accès, travailler plus clairement et adopter les bons outils sans
                improviser.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild size="lg" variant="secondary">
                <Link href="/contact?source=hygiene-informatique">Parler à ForméducWeb</Link>
              </Button>
            </div>
          </div>
          ...
          <Card className="border-primary/20 bg-primary/5">
            ...
            <CardContent className="space-y-5 text-sm leading-7 text-muted-foreground">
              <p>
                Une bonne hygiène informatique, c'est l'ensemble des habitudes qui gardent les données, les accès, les
                sauvegardes, les outils et les usages IA sous contrôle.
              </p>
              <p>
                Pour une PME, c'est aussi un avantage: moins de confusion, moins de données inutiles, moins de risques
                courants et plus de confiance dans les échanges avec les clients.
              </p>
              <div className="grid gap-3">
                {["Données mieux connues", "Accès mieux justifiés", "IA mieux encadrée"].map((item) => (
                  <div key={item} className="flex items-center gap-3 rounded-2xl border border-border/70 bg-white/75 p-3">
            ...
            return (
              <Card key={cluster.title} className="flex h-full flex-col">
                ...
                <CardContent className="flex flex-1 flex-col gap-5">
                  <p className="text-sm leading-7 text-muted-foreground">{cluster.description}</p>
